    ...
    def run(self):
        ...
        #df2 = (self.df
		  ...
		  # The beam-spot dimensions are passed in mum :
               .Define("VertexObject_primaryTracks_BSC",  "FCCAnalyses::VertexFitterSimple::VertexFitter ( 1, MC_PrimaryTracks_RP, EFlowTrack_1, true, 4.5, 20e-3, 300) ")
               ...
               .Define("FinalVertexObject",   "FCCAnalyses::VertexFitterSimple::VertexFitter_Tk ( 1, RecoedPrimaryTracks, true, 4.5, 20e-3, 300) ")
