    ...
    def analysers(df):
        df2 = (
            df
                ...
                .Define("KstRecoParticles_d0", "FCCAnalyses::ReconstructedParticle2Track::getRP2TRK_D0(KstRecoParticles,SmearedTracks)")
                .Define("KstRecoParticles_z0", "FCCAnalyses::ReconstructedParticle2Track::getRP2TRK_Z0(KstRecoParticles,SmearedTracks)")
                ...
                .Define("taumRecoParticles_d0", "FCCAnalyses::ReconstructedParticle2Track::getRP2TRK_D0(taumRecoParticles,SmearedTracks)")
                .Define("taumRecoParticles_z0", "FCCAnalyses::ReconstructedParticle2Track::getRP2TRK_Z0(taumRecoParticles,SmearedTracks)")
                ...
                .Define("taupRecoParticles_d0", "FCCAnalyses::ReconstructedParticle2Track::getRP2TRK_D0(taupRecoParticles,SmearedTracks)")
                .Define("taupRecoParticles_z0", "FCCAnalyses::ReconstructedParticle2Track::getRP2TRK_Z0(taupRecoParticles,SmearedTracks)")
