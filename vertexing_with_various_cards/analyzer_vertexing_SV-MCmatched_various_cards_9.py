processList = {
    ...
    'output':'lighterVXD_50pc_lighterBP_50pc'}
} 
# 1: 10^7
# 0.1: 10^6
# 0.01: 10^5
...
inputDir    = "/eos/experiment/fcc/ee/generation/DelphesEvents/winter2023_variations/IDEA/lighterVXD_50pc_lighterBP_50pc"
outputDir   = "/afs/cern.ch/work/t/tmiralle/public/FCCAnalyses/vertexing_with_various_cards/vertexing_output_various_cards/lighterVXD_50pc_lighterBP_50pc"
nCPUS       = 2
runBatch    = True
