...
#include "vertex_resolution_SH30.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void vertex_resolution_last::Loop()
{
    ...
    TFile *f = new TFile("/afs/cern.ch/work/t/tmiralle/public/FCCAnalyses/vertexing_with_various_cards/various_cards_tuples/vertex_resolution_SH30.root", "RECREATE");
    f -> cd();
