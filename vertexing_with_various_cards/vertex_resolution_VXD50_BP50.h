#ifndef vertex_resolution_VXD50_BP50_h
#define vertex_resolution_VXD50_BP50_h
...
vertex_resolution_last::vertex_resolution_last(TTree *tree) : fChain(0) 
{
   if (tree == 0) {
      #ifdef SINGLE_TREE
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/t/tmiralle/public/FCCAnalyses/vertexing_with_various_cards/vertexing_output_various_cards/lighterVXD_50pc_lighterBP_50pc/p8_ee_Zbb_ecm91_EvtGen_Bd2KstarTauTau/chunk0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/work/t/tmiralle/public/FCCAnalyses/vertexing_with_various_cards/vertexing_output_various_cards/lighterVXD_50pc_lighterBP_50pc/p8_ee_Zbb_ecm91_EvtGen_Bd2KstarTauTau/chunk0.root");
      }
      ...
      for (int i = 0; i < 1; i++) {
         ...
         string file_name = "/afs/cern.ch/work/t/tmiralle/public/FCCAnalyses/vertexing_with_various_cards/vertexing_output_various_cards/lighterVXD_50pc_lighterBP_50pc/p8_ee_Zbb_ecm91_EvtGen_Bd2KstarTauTau/chunk" + file_number + ".root/events";
      ...
      // string file_name = "/afs/cern.ch/work/t/tmiralle/public/FCCAnalyses/vertexing_output/vertexing_test_SVMCmatched.root/events";
      // const char *c = file_name.c_str();
      // chain -> Add(c);
