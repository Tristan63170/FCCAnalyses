...
outputDir   = "/afs/cern.ch/work/t/tmiralle/public/FCCAnalyses/vertexing_output_smeared_omega0"
nCPUS       = 2
runBatch    = True
    ...
    def analysers(df):
        df2 = (
            df
                ...
                .Define("SmearedTracks", "FCCAnalyses::SmearObjects::SmearedTracks(1.0, 1.0, 0.5, 1.0, 1.0,false) (ReconstructedParticles, EFlowTrack_1, RP_MC_index, Particle)")
