...
#include "vertex_resolution_last.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void vertex_resolution_last::Loop()
{
    ...
    TFile *f = new TFile("/afs/cern.ch/work/t/tmiralle/public/FCCAnalyses/vertexing_output/p8_ee_Zbb_ecm91_EvtGen_Bd2KstarTauTau/vertex_resolution_last.root", "RECREATE");
    f -> cd();
