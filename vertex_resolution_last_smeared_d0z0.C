...
#include "vertex_resolution_last_smeared_d0z0.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void vertex_resolution_last::Loop()
{
    ...
    TFile *f = new TFile("/afs/cern.ch/work/t/tmiralle/public/FCCAnalyses/vertexing_output_smeared_d0z0/p8_ee_Zbb_ecm91_EvtGen_Bd2KstarTauTau/vertex_resolution_last_smeared_d0z0.root", "RECREATE");
    f -> cd();
