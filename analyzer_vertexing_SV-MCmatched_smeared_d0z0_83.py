...
outputDir   = "/afs/cern.ch/work/t/tmiralle/public/FCCAnalyses/vertexing_output_smeared_d0z0_83"
nCPUS       = 2
runBatch    = True
    ...
    def analysers(df):
        df2 = (
            df
                ...
                .Define("SmearedTracks", "FCCAnalyses::SmearObjects::SmearedTracks(0.83, 1.0, 1.0, 0.83, 1.0,false) (ReconstructedParticles, EFlowTrack_1, RP_MC_index, Particle)")
