...
class analysis():
    ...
    def run(self):
        ...
        df2 = (self.df
               ...
               .Define("KstRecoParticles",   " FCCAnalyses::ReconstructedParticle2MC::selRP_matched_to_list( Kst2KPi_indices, MCRecoAssociations0,MCRecoAssociations1,ReconstructedParticles,Particle)")

               # the corresponding tracks - here, dummy particles, if any, are removed
               .Define("KstTracks",  "FCCAnalyses::ReconstructedParticle2Track::getRP2TRK( KstRecoParticles, EFlowTrack_1)" )

               # number of tracks used to reconstruct the Ds vertex
               .Define("n_KstTracks", "FCCAnalyses::ReconstructedParticle2Track::getTK_n( KstTracks )")

               # Reco'ed vertex of the Kstar  ( = reco'ed decay vertex of the Bd from the K+ and Pi- tracks only)
               .Define("KstVertexObject",  "FCCAnalyses::VertexFitterSimple::VertexFitter_Tk( 2, KstTracks)" )
               .Define("KstVertex",  "FCCAnalyses::VertexingUtils::get_VertexData( KstVertexObject )")
